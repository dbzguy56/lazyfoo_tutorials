...
bool loadMedia()
{
	...
	else
	{
		...
		//Load prompt texture
		if(!gStartPromptTexture.loadFromRenderedText("Press S to Reset Start or Stop the Timer.", textColor))
		{
